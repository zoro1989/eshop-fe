<template>
  <div class="app-container">
    <div class="opt-bar">
      <el-button type="primary" @click="dialogFormVisible = true">添加提成方式</el-button>
    </div>
    <el-table
      :data="tableData"
      border
    ...
    <el-dialog title="编辑轮播页" :visible.sync="dialogFormVisible">
      <el-form :model="form">
        <el-form-item label="提成名称" :label-width="formLabelWidth">
          <el-input
            class="search-input"
            placeholder="请输入提成名称"
            v-model="form.title">
